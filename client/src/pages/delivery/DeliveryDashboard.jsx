                ...
                <div className="mb-8">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="mt-2 text-gray-600">Manage your deliveries and track performance</p>
                        </div>
                        ...
                        <div className="grid gap-6">
                            {availableOrders.length === 0 ? (
                                <div className="rounded-xl bg-white p-12 text-center shadow-sm ring-1 ring-gray-200">
                                    ...
                                    <p className="mt-2 text-gray-600">Check back later for new delivery opportunities.</p>
                                </div>
                            ) : (
                                availableOrders.map((order) => (
                                    <div key={order.id} className="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
                                        <div className="flex flex-col space-y-4 lg:flex-row lg:items-center lg:justify-between lg:space-y-0">
                                            <div className="flex-1">
                                                ...
                                                <div className="mt-2 grid grid-cols-1 gap-4 sm:grid-cols-2">
                                                    ...
                                                    <div>
                                                        <p className="text-sm text-gray-600">Items: {order.items?.map(item => `${item.name} (${item.quantity})`).join(', ')}</p>
                        ...
                        <div className="grid gap-6">
                            {outForDelivery.length === 0 ? (
                                <div className="rounded-xl bg-white p-12 text-center shadow-sm ring-1 ring-gray-200">
                                    ...
                                    <h3 className="mt-4 text-lg font-medium text-gray-900">No active deliveries</h3>
                                    <p className="mt-2 text-gray-600">Accept orders from the available tab to start delivering.</p>
                                </div>
                            ) : (
